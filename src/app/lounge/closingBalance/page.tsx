...
const LoungeOpeningBalancePage = () => {
  ...
  async function submitClosingBalance() {
    ...
    try {
      await axios.put(`${process.env.NEXT_PUBLIC_API_BASE}/api/lounge/closingBalance`, updatedRows)
        .then(() => {
          setLoading(false);
  ...
  return (
    <div>
      <div className='flex flex-row gap-3'>
        ...
        <h1 className="text-3xl font-semibold capitalize">Lounge Closing Balance</h1>
      </div>
