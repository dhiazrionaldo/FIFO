...
import { LoungeDrawerDialog } from '@/app/lounge/openingBalance/storage_list';
...
const LoungeOpeningBalancePage = () => {
  ...
  async function submitOpeningBalance() {
    ...
    try {
      await axios.put(`${process.env.NEXT_PUBLIC_API_BASE}/api/lounge/openingBalance`, updatedRows)
        .then(() => {
          setLoading(false);
  ...
  return (
    <div>
      <div className='flex flex-row gap-3'>
        ...
        <h1 className="text-3xl font-semibold capitalize">Lounge Opening Balance</h1>
      </div>
      ...
      <div className="mt-10 justify-between items-center">
        ...
        {formattedRows.length > 0 ? (
            ...
            >
              ...
              <CardContent className="grid grid-cols-2 gap-6">
                ...
                <div className='grid grid-row-2 gap-3'>
                  <label className='block text-md font-bold'>Lounge Qty.</label>
          ...
          <div>
            ...
            <p className='py-2'>Please choose the lounge stock first before proceeding</p>
          </div>
        )}
      </div>
    </div>
...
export default LoungeOpeningBalancePage;